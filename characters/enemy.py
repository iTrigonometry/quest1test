...
"""
    ...
    #TODO добавить возможность экипировки оружия
            теперь она есть по дефолту у любого персонажа
"""

#TODO В СТАДИИ РАЗРАБОТКИ так как в планах последним боссом сделать STYROSTA, то у него завышеные характеристики, думаю стоит добавить изменение его характеристик по ходу сюжета
